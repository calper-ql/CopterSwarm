...
namespace HiveEngine {
    ...
    std::pair<std::vector<glm::vec3>, std::vector<glm::vec3>> generate_entity_line_description(Entity_Deprecated* e, glm::vec3 scale); // generates lines for renderer, scales each dim, 0.0 -> 1.0
